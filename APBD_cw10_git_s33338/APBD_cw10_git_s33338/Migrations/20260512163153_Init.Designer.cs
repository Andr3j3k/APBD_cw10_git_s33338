...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.Component", b =>
                {
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.Component", b =>
                {
                    b.HasOne("APBD_cw10_git_s33338.Entities.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("APBD_cw10_git_s33338.Entities.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("APBD_cw10_git_s33338.Entities.PCComponent", b =>
                {
                    b.HasOne("APBD_cw10_git_s33338.Entities.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("APBD_cw10_git_s33338.Entities.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
